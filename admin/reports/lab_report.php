   ...
   border-left-color:#000;
	...
	<script type="text/javascript">
		function search(){
			...
			var from=$("#from").val();
			var to=$("#to").val();
			getData(test_id,from,to);
		}
		function getData(test_id,from,to){
		$.ajax(
			{
				async: false,
				url: "../../ajax/rsp_getLabReport.php",
				data: "test_id="+test_id+"&from="+from+"&to="+to,
...
<body id="main_body" >
<h2 style="text-align:center;">Lab Report</h2>
